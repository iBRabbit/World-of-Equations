    ...
    <div className="navbar px-4 shadow-md fixed w-full top-0 left-0 z-10" style={{ backgroundColor: "#f9f9f9" }}>
      ...
      <div className="navbar-center hidden lg:flex">
        <div className="relative">
          <input type="text" className="input input-bordered pl-4 pr-12 py-2 rounded-full w-96 shadow-sm focus:outline-none focus:ring-2" style={{ borderColor: "#f97316", color: "#1f2937" }} placeholder="Search" />
      ...
      <div className="navbar-end">
        ...
        {isAuthenticated && (
          ...
          <ul className="menu menu-horizontal px-1">
            <li>
              <a href="/" className="px-4" style={{ color: "#1f2937" }}>
                Home
              </a>
            </li>
            <li>
              <a className="px-4" style={{ color: "#1f2937" }}>
                Courses
              </a>
            </li>
            <li>
